...
let g:airline#themes#concerto#palette = {}
...
let g:airline#themes#concerto#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#concerto#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#concerto#palette.normal = {
...
let s:airline_a_insert = [ '#00005f' , '#00dfff' , 17  , 110  ]
let s:airline_b_insert = [ '#ffffff' , '#005fff' , 234 , 59    ]
let s:airline_c_insert = [ '#ffffff' , '#000080' , 72  , 234   ]
let g:airline#themes#concerto#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#concerto#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 234     , 59      , ''     ] ,
      \ }
let g:airline#themes#concerto#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#concerto#palette.replace = copy(g:airline#themes#concerto#palette.insert)
let g:airline#themes#concerto#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#concerto#palette.replace_modified = g:airline#themes#concerto#palette.insert_modified
...
let g:airline#themes#concerto#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#concerto#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#concerto#palette.insert.airline_error =
    \ g:airline#themes#concerto#palette.normal.airline_error

let g:airline#themes#concerto#palette.insert_modified.airline_error =
    \ g:airline#themes#concerto#palette.normal.airline_error

let g:airline#themes#concerto#palette.visual.airline_error =
    \ g:airline#themes#concerto#palette.normal.airline_error

let g:airline#themes#concerto#palette.visual_modified.airline_error =
    \ g:airline#themes#concerto#palette.normal.airline_error

let g:airline#themes#concerto#palette.replace.airline_error =
    \ g:airline#themes#concerto#palette.normal.airline_error
